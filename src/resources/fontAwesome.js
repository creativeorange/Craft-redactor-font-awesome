...
RedactorPlugins.fontAwesome = function()
{
    return {
        ...
        show: function()
        {
            ...
            this.modal.addTemplate('fontAwesome', this.fontAwesome.getTemplate(len, icons));
            this.modal.load('fontAwesome', 'Font awesome icons', 800);
            ...
            savebutton.on('click', this.fontAwesome.insert);
